                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <select class="form-control" name="ftahun_pembuatan" id="ftahun_pembuatan">
                                ...
                                <option value="{{ $y }}" @if($y == $ftahun_pembuatan) selected="selected" @endif>{{ $y }}</option>
                                @endfor
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <select class="form-control col-sm-8" name="finstansiname" id="finstansiname" style="width:100%">
                                ...
                                <option value="{{ $in->name }}" @if($in->name == $finstansiname) selected="selected" @endif>{{ $in->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="form-group row" style="display:none">
                        ...
                        <div class="col-sm-8">
                            <select class="form-control" name="fid_jenis" id="fid_jenis">
                                ...
                                <option value="{{ $peraturan->id_jenis }}">{{ $peraturan->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <select class="form-control" name="fid_jenis_sub" id="fid_jenis_sub">
                                <option value="">Semua</option>
                                @foreach($peraturan_subs as $peraturan_sub)
                                <option value="{{ $peraturan_sub->id_jenis_sub }}" @if($peraturan_sub->id_jenis_sub == $fid_jenis_sub) selected="selected" @endif>{{ $peraturan_sub->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <select class="form-control" name="fstatus" id="fstatus">
                                <option value="">Semua</option>
                                @foreach($status as $st=>$stn)
                                <option value="{{ $st }}" @if($st == $fstatus) selected="selected" @endif>{{ $stn }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
