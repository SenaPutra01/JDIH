...
<div class="d-sm-flex align-items-center justify-content-between mb-3">
    <h1 class="h3 mb-0 text-gray-800"><i class="fa fa-pen fa-sm"></i> Ubah Berita</h1>
            ...
            <div class="row">
                <div class="col-12 col-sm-6">
                    @foreach($data as $item)
                        <div class="form-group row">
                            <label for="judul" class="col-sm-4 col-form-label">Judul Berita<span class="text-danger ml-1">*</span></label>
                            <div class="col-sm-8">
                                <!-- <textarea name="judul_berita" id="judul_berita" cols="30" rows="3" class="form-control">{{ $item->title }}</textarea> -->
                                <input type="text" class="form-control" name="judul" id="judul" value="{{ old('judul') ? old('judul') : $item->judul }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="deskripsi" class="col-sm-4 col-form-label">Deskripsi Singkat <span class="text-danger ml-1">*</span></label>
                            <div class="col-sm-8">
                                <textarea name="deskripsi" id="deskripsi" cols="30" rows="6" class="form-control">{{ $item->deskripsi }}</textarea>
                            </div>
                        </div>
                    @endforeach
                </div>
