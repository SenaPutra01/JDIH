            ...
            <div class="row">
                <div class="col-12 col-sm-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="judul" id="judul" value="{{old('judul') ? old('judul') : $data->judul}}" required autofocus>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="konten" id="konten" value="{{$data->konten}}" required>
                        </div>
                    </div>
                <!-- <div class="form-group row">
    ...
    <div class="card mb-4">
        ...
        <div class="card-footer">
            <div class="float-right">
                <a class="d-none d-sm-inline-block btn btn-secondary shadow-sm mr-2" href="{{ route('halaman.index') }}"> Batalkan</a>
...
$('#form').submit(function(e){
    ...
    if($(this).valid()){
        ...
        $.ajax({
            url: "{{ Route('halaman.update', $data->id) }}",
            type: 'POST',
            ...
            success: function(data) {
                alert(data.message)
                document.location.href = "{{ Route('halaman.index') }}"
            },
            error : function(data){
