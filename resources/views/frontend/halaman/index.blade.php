...
<div class="d-sm-flex align-items-center justify-content-between mb-3">
    ...
    <a href="{{ Route('halaman.create') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus fa-sm text-white-50 mr-1"></i> Tambah Halaman</a>
</div>
