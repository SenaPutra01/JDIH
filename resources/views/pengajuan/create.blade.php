            ...
            <div class="row">
                <div class="col-12 col-sm-6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <select class="form-control" name="id_jenis_sub" id="id_jenis_sub" required>
                                ...
                                <option value="{{ $peraturan_sub->id_jenis_sub }}">{{ $peraturan_sub->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" readonly class="form-control col-sm-6 calendar" name="tgl_booking" id="tgl_booking" value="{{ $year }}" style="background:#FFF" required>
                        </div>
                    </div>
                    <div class="form-group row">
    ...
    if($(this).valid()){
        ...
        $.ajax({
            ...
            success: function(data) {
                alert(data.message)
                document.location.href = "{{ Route('pengajuan.index') }}"
            },
            error : function(data){
