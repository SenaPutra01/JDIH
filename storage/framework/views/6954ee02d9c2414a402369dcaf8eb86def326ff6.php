            ...
            <div class="row">
                <div class="col-12 col-sm-6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="konten" id="konten" placeholder="Isi dengan # (tanda pagar) jika memiliki sub menu" required>
                        </div>
                    </div>
                    <!-- <div class="form-group row">
...
$('#form').submit(function(e){
    ...
    if($(this).valid()){
        ...
        $.ajax({
            url: "<?php echo e(route('halaman.store')); ?>",
            type: 'POST',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Downloads\kominfo.jdih-main\resources\views/frontend/halaman/create.blade.php ENDPATH**/ ?>