            ...
            <div class="row">
                <div class="col-12 col-sm-6">
                    <div class="form-group row">
                        <label for="judul_halaman" class="col-sm-4 col-form-label">Judul Halaman <span class="text-danger ml-1">*</span></label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="judul_halaman" id="judul_halaman" required autofocus>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="deskripsi_halaman" class="col-sm-4 col-form-label">Deskripsi <span class="text-danger ml-1">*</span></label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="deskripsi_halaman" id="deskripsi_halaman" required>
                        </div>
                    </div>
                    <div class="form-group row">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookpro/Documents/jdih_dev/resources/views/frontend/halaman/create.blade.php ENDPATH**/ ?>