...
function show(id){
    $('#loading').show();
    $.get("<?php echo e(Route('pengajuan.show', ':id')); ?>".replace(':id', id), function(data){
        ...
        if(data.upload_files.length > 0){
            sftp_src = "<?php echo e(config('app.sftp_src')); ?>";
...
</script><?php /**PATH /Users/macbookpro/Documents/Diskominfo Projects/jdih_dev/resources/views/pengajuan/_show_js.blade.php ENDPATH**/ ?>