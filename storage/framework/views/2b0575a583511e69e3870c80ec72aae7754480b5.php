                ...
                <div class="col-12 col-sm-6">
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <textarea name="judul_berita" id="judul_berita" cols="30" rows="3" class="form-control"><?php echo e($item->title); ?></textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <textarea name="deskripsi_singkat" id="deskripsi_singkat" cols="30" rows="6" class="form-control"><?php echo e($item->short_description); ?></textarea>
                            </div>
                        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookpro/Documents/Diskominfo Projects/jdih_dev/resources/views/frontend/berita/edit.blade.php ENDPATH**/ ?>