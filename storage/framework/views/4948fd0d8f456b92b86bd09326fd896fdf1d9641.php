...
<div class="d-sm-flex align-items-center justify-content-between mb-3">
    <h1 class="h3 mb-0 text-gray-800"><i class="fa fa-plus fa-sm"></i> Tambah Halaman</h1>
            ...
            <div class="row">
                <div class="col-12 col-sm-6">
                    <div class="form-group row">
                        <label for="judul" class="col-sm-4 col-form-label">Judul Halaman <span class="text-danger ml-1">*</span></label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="judul" id="judul" value="<?php echo e(old('judul') ? old('judul') : $data->judul); ?>" required autofocus>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="deskripsi" class="col-sm-4 col-form-label">Deskripsi <span class="text-danger ml-1">*</span></label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="deskripsi" id="deskripsi" value="<?php echo e($data->deskripsi); ?>"  required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="konten" class="col-sm-4 col-form-label">Konten <span class="text-danger ml-1">*</span></label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="konten" id="konten" value="<?php echo e($data->konten); ?>" required>
                        </div>
                    </div>
                <!-- <div class="form-group row">
    ...
    <div class="card mb-4">
        ...
        <div class="card-footer">
            <div class="float-right">
                <a class="d-none d-sm-inline-block btn btn-secondary shadow-sm mr-2" href="<?php echo e(route('halaman.index')); ?>"> Batalkan</a>
...
$('#form').submit(function(e){
    ...
    if($(this).valid()){
        ...
        $.ajax({
            url: "<?php echo e(Route('halaman.update', $data->id)); ?>",
            type: 'POST',
            ...
            success: function(data) {
                alert(data.message)
                document.location.href = "<?php echo e(Route('halaman.index')); ?>"
            },
            error : function(data){
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Downloads\kominfo.jdih-main\resources\views/frontend/halaman/edit.blade.php ENDPATH**/ ?>