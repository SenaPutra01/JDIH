                ...
                <div class="col-12 col-sm-6">
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nama_menu" id="nama_menu" value="<?php echo e($item->nama_menu); ?>" required autofocus>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="nomor_urut" class="col-sm-4 col-form-label">Nomor Urut <span class="text-danger ml-1">*</span></label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nomor_urut" id="nomor_urut" value="<?php echo e($item->no_urut); ?>" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="link" class="col-sm-4 col-form-label">Link <span class="text-danger ml-1">*</span></label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="link" id="link" placeholder="Isi dengan # (tanda pagar) jika memiliki sub menu"  value="<?php echo e($item->link); ?>" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select name="submenu" id="submenu" class="form-control" required>
                                    ...
                                    <option value="1" <?php if($item->has_submenu == 1): ?> selected <?php endif; ?>>Ada</option>
                                    <option value="0" <?php if($item->has_submenu == 0): ?> selected <?php endif; ?>>Tidak Ada</option>
                                </select>
                            </div>
                        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookpro/Documents/Diskominfo Projects/jdih_dev/resources/views/frontend/menu/edit.blade.php ENDPATH**/ ?>